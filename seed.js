...
const products = [
  ...
  },
  {
    ...
    reviews: [
      { user: reviewerIds[0], name: reviewerNames[0], rating: 5, comment: "The camera is the best I've used — Magic Editor is genuinely magic." },
      { user: reviewerIds[1], name: reviewerNames[1], rating: 4, comment: "Buttery smooth, clean Android. Wish it charged faster." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[3], name: reviewerNames[3], rating: 5, comment: "Leica photos look incredible straight out of the camera." },
      { user: reviewerIds[2], name: reviewerNames[2], rating: 4, comment: "Huge battery and fast charging. MIUI has minor bloat." },
    ],
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=500&q=80"],
    featured: true,
    specs: [
    ...
    reviews: [
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "XDR display and M3 Pro handle 4K editing without breaking a sweat." },
      { user: reviewerIds[0], name: reviewerNames[0], rating: 5, comment: "Silent under load and the battery genuinely lasts all day." },
    ],
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1544377193-33dcf4d68fb5?w=500&q=80"],
    featured: false,
    specs: [
    ...
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 4, comment: "OLED is gorgeous and the 360 hinge feels premium. Fans spin up occasionally." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[3], name: reviewerNames[3], rating: 5, comment: "Runs everything I throw at it and still fits in a backpack." },
      { user: reviewerIds[1], name: reviewerNames[1], rating: 4, comment: "Great screen and performance. Gets warm under long gaming sessions." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[0], name: reviewerNames[0], rating: 4, comment: "Fitbit insights are excellent. Design is elegant, battery is one-day." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 5, comment: "Training readiness changed how I run. Battery lasts almost two weeks." },
      { user: reviewerIds[3], name: reviewerNames[3], rating: 4, comment: "Brilliant GPS accuracy. Setup takes a bit of patience." },
    ],
  },
  {
    ...
    price: 37990,
    countInStock: 32,
    image: "https://images.unsplash.com/photo-1553603227-2358aabe821e?w=500&q=80",
    images: ["https://images.unsplash.com/photo-1553603227-2358aabe821e?w=500&q=80"],
    featured: true,
    specs: [
      { label: "Type", value: "Over-ear, wireless" },
    ...
    reviews: [
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "ANC is unreal and Spatial Audio makes everything feel cinematic." },
      { user: reviewerIds[0], name: reviewerNames[0], rating: 4, comment: "Superb comfort for long flights. Pricey but worth it." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 5, comment: "Eye-tracking AF is flawless even at 40fps. Video and stills both superb." },
    ],
  },
  {
    ...
    price: 219999,
    countInStock: 6,
    image: "https://images.unsplash.com/photo-1500634245200-e5245c7574ef?w=500&q=80",
    images: ["https://images.unsplash.com/photo-1500634245200-e5245c7574ef?w=500&q=80"],
    featured: false,
    specs: [
    ...
    reviews: [
      { user: reviewerIds[3], name: reviewerNames[3], rating: 5, comment: "Perfect hybrid camera. AF locks on instantly and colors are gorgeous." },
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "Upgraded from an A7 III — huge leap in resolution and video features." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[0], name: reviewerNames[0], rating: 5, comment: "The SSD load times and DualSense haptics are a generational leap." },
      { user: reviewerIds[2], name: reviewerNames[2], rating: 4, comment: "Incredible console, just wish the storage filled up slower." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "The OLED screen makes handheld play look stunning. Perfect family console." },
    ],
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1598965402089-897ce52e8355?w=500&q=80"],
    featured: false,
    specs: [
    ...
    reviews: [
      { user: reviewerIds[0], name: reviewerNames[0], rating: 5, comment: "Compact, clean Android, and the camera punches way above its price." },
      { user: reviewerIds[3], name: reviewerNames[3], rating: 4, comment: "Best value Pixel in years. Battery could be bigger but it lasts the day." },
    ],
  },
  {
    ...
    price: 99999,
    countInStock: 15,
    image: "https://images.unsplash.com/photo-1565849904461-56822589df05?w=500&q=80",
    images: ["https://images.unsplash.com/photo-1565849904461-56822589df05?w=500&q=80"],
    featured: true,
    specs: [
    ...
    reviews: [
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "The Flex Window is genuinely useful and it finally folds completely flat." },
      { user: reviewerIds[2], name: reviewerNames[2], rating: 4, comment: "Gorgeous phone, just mind the crease and the modest battery." },
    ],
  },
  {
    name: "iQOO 12 5G",
    ...
    specs: [
      ...
      { label: "Chipset", value: "Snapdragon 8 Gen 3" },
      { label: "Camera", value: "50MP Main + 50MP Ultra Wide + 64MP Telephoto" },
      { label: "Charging", value: "120W FlashCharge" },
      { label: "Battery", value: "5000 mAh" },
    ],
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 5, comment: "120W charging is ridiculous — full battery in around 20 minutes." },
      { user: reviewerIds[0], name: reviewerNames[0], rating: 4, comment: "Buttery 144Hz screen and superb performance for the money." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "Sixty hours of battery is unreal, and the sound is warm and detailed." },
      { user: reviewerIds[3], name: reviewerNames[3], rating: 5, comment: "Most comfortable headphones I own. ANC is excellent on commutes." },
    ],
  },
  {
    name: "Nothing Ear (2)",
    ...
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 4, comment: "Stunning design and clean bass. The Glyph case lights are a nice touch." },
      { user: reviewerIds[0], name: reviewerNames[0], rating: 4, comment: "Great value TWS with solid ANC and a distinctive look." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[3], name: reviewerNames[3], rating: 5, comment: "The AMOLED panel and included S Pen make it perfect for notes and media." },
      { user: reviewerIds[1], name: reviewerNames[1], rating: 4, comment: "Fast and beautiful. DeX mode genuinely replaces a laptop for light work." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 5, comment: "That keyboard is still the best in the business, and the OLED is gorgeous." },
      { user: reviewerIds[0], name: reviewerNames[0], rating: 4, comment: "Feather light and built like a tank. Battery easily covers a work day." },
    ],
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1545454675-3531b543be5d?w=500&q=80"],
    featured: false,
    specs: [
      { label: "Type", value: "Portable Bluetooth" },
    ...
    reviews: [
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "Looks iconic and sounds huge for its size. 30-hour battery is no exaggeration." },
      { user: reviewerIds[3], name: reviewerNames[3], rating: 4, comment: "Excellent build and sound. Wish it came with a proper carrying case." },
    ],
  },
  {
    name: "Fitbit Sense 2",
    ...
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 4, comment: "Stress tracking and ECG are surprisingly insightful. Battery lasts all week." },
      { user: reviewerIds[0], name: reviewerNames[0], rating: 4, comment: "Great health data and a comfortable band. App subscription is a downside." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[3], name: reviewerNames[3], rating: 5, comment: "HyperSmooth 6.0 is witchcraft — footage looks like it's on a gimbal." },
      { user: reviewerIds[1], name: reviewerNames[1], rating: 4, comment: "Tough, tiny and incredible in bright daylight. Low light is just okay." },
    ],
  },
  {
    name: "Xbox Series X",
    ...
    reviews: [
      { user: reviewerIds[2], name: reviewerNames[2], rating: 5, comment: "Quiet, powerful and Quick Resume is the best next-gen feature, period." },
      { user: reviewerIds[0], name: reviewerNames[0], rating: 4, comment: "Great console and Game Pass makes it unbeatable value." },
    ],
  },
  {
    ...
    reviews: [
      { user: reviewerIds[1], name: reviewerNames[1], rating: 5, comment: "The scroll wheel alone is worth it. Ergonomics are superb for long days." },
      { user: reviewerIds[3], name: reviewerNames[3], rating: 4, comment: "Flawless across Windows and Mac. Quiet clicks are a blessing in offices." },
    ],
  },
];
